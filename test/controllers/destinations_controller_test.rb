...
class DestinationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create destination" do
    assert_difference('Destination.count') do
      post destinations_url, params: { destination: { key: @destination.key, name: @destination.name, url: @destination.url } }
    end
  ...
  test "should update destination" do
    patch destination_url(@destination), params: { destination: { key: @destination.key, name: @destination.name, url: @destination.url } }
