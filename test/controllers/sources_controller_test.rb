...
class SourcesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create source" do
    assert_difference('Source.count') do
      post sources_url, params: { source: { medium: @source.medium, name: @source.name, url: @source.url } }
    end
  ...
  test "should update source" do
    patch source_url(@source), params: { source: { medium: @source.medium, name: @source.name, url: @source.url } }
